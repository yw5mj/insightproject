...
def page1(bars):
    ...
    html.Div([        
        ...
        html.Div(id='barname'),],style={'marginLeft': margin,'marginRight': margin}),
    html.Hr(),
    html.H2(children='Step 2',style={'textAlign': 'center'}),
    html.Div([
        html.Div(children='Enter your beeradvocate.com username (eg. zimm421):'),
        ...
        html.Div(id='beerid'),],style={'marginLeft': margin,'marginRight': margin}),
    html.Hr(),
...
def recom(beerid,beerinfo):
    ...
    return [html.Div([html.H3(children=info['beer'].iloc[0])],style={'marginLeft': margin}),
            html.Div([
                html.Div(
                ...
                html.Div([html.Br()]*7+[
                    ...
                    html.Div(children='serve: {0}'.format(' '.join(serve))),
                         ...
                         , className="six columns")],className="row",style={'marginLeft': margin}),
            html.Hr()
    ]
